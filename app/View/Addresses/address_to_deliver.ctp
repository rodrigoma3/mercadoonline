...
<?php echo $this->Form->create('Address'); ?>
	<fieldset>
		<legend><?php echo __('Verificar Endereço'); ?></legend>
	<?php
		echo $this->Form->input('cep', array('label' => 'CEP', 'class' => 'form-control', 'maxlength' => '8'));
...
<div class="actions">
	<?php echo $this->Form->end(array('label' => 'Verificar', 'div' => false)); ?>
</div>
