						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<?php foreach ($category['manufacturers'] as $idManufacturer => $nameManufacturer): ?>
									<a href="/products/category/<?php echo $idCategory.'/manufacturer/'.$idManufacturer; ?>"><?php echo $nameManufacturer; ?> </a>
								<?php endforeach; ?>
							</h4>
						</div>
					</div>
							...
							<div class="product-overlay">
								<div class="overlay-content text-center">
									<div class="form form-group">
										...
										<?php echo $this->Form->input('CartsProduct.cart_id', array('type' => 'hidden', 'value' => $cart['Cart']['id'], 'class' => 'form-control', 'div' => false)); ?>
